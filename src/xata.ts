...
const tables = [
  {
    ...
    columns: [
      ...
      { name: "Workspace", type: "link", link: { table: "WorkspaceData" } },
    ],
  ...
  },
  {
    ...
    revLinks: [{ column: "Workspace", table: "FolderData" }],
  },
] as const;
...
export type WorkspaceData = InferredTypes["WorkspaceData"];
export type WorkspaceDataRecord = WorkspaceData & XataRecord;

export type DatabaseSchema = {
  FolderData: FolderDataRecord;
  Filedata: FiledataRecord;
  WorkspaceData: WorkspaceDataRecord;
};
